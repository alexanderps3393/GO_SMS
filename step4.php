...
<table>
 	<tr><td>ID PHONE</td><td>:</td><td>
	<input type="text" name="id2" value="<?php echo $id2;?>"></td></tr>
 	<tr><td>PORT</td><td>:</td><td>
	<input type="text" name="port2" value="<?php echo $port2;?>"></td></tr>
 	<tr><td>CONNECTION</td><td>:</td><td>
	<input type="text" name="connection2" value="<?php echo $connection2;?>"></td></tr>
</table>
...
<table>
	<tr><td>ID PHONE</td><td>:</td><td>
	<input type="text" name="id3" value="<?php echo $id3;?>"></td></tr>
 	<tr><td>PORT</td><td>:</td><td>
	<input type="text" name="port3" value="<?php echo $port3;?>"></td></tr>
 	<tr><td>CONNECTION</td><td>:</td><td>
	<input type="text" name="connection3" value="<?php echo $connection3;?>"></td></tr>
</table>
...
<table>
 	<tr><td>ID PHONE</td><td>:</td><td>
 	<input type="text" name="id4" value="<?php echo $id4;?>"></td></tr>
 	<tr><td>PORT</td><td>:</td><td>
 	<input type="text" name="port4" value="<?php echo $port4;?>"></td></tr>
 	<tr><td>CONNECTION</td><td>:</td><td>
 	<input type="text" name="connection4" value="<?php echo $connection4;?>"></td></tr>
</table>
<br>
